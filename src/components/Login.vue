<template>
  ...
  <div id="formContent">
    ...
    <!-- Login Form -->
    <form v-on:submit.prevent="loginpanel">
      <input type="text" id="login" class="fadeIn second" name="login" placeholder="username" v-model="input.login">
...
export default {
   ...
   methods: {
     loginpanel(){
       if(this.input.login == "recruiter@screel.in")
       {
